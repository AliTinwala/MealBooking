...
namespace MealBookingAPI.Data.Repository
{
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        public async Task<IEnumerable<Notification>> GetNotificationsByUserId(Guid user_id)
        {
        ...
        public async Task<Notification> SetReadNotificationForUser(Guid notification_id)
        {
